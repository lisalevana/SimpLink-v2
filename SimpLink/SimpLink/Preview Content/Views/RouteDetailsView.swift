...
struct RouteDetailsView: View {
        ...
        ScrollView {
            VStack(alignment: .leading, spacing: 16) {
                ...
                ForEach(steps) { step in
                    ...
                    case .bus(let from, let to, let stops, let duration):
                        busStep(from: from, to: to, stops: stops, duration: duration)
    ...
    private func busStep(from: String, to: String, stops: [String], duration: Int) -> some View {
